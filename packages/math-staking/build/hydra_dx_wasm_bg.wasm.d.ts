...
export function calculate_rewards(a: number, b: number, c: number, d: number, e: number, f: number, g: number): void;
export function calculate_percentage_amount(a: number, b: number, c: number, d: number, e: number): void;
