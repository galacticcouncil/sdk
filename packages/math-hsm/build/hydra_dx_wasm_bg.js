 ...
 * @returns {string}
 */
export function calculate_hollar_out_given_collateral_in(amount_in, collateral_peg, purchase_fee) {
    let deferred4_0;
    let deferred4_1;
    try {
 ...
 * @returns {string}
 */
export function calculate_collateral_in_given_hollar_out(amount_out, collateral_peg, purchase_fee) {
    let deferred4_0;
    let deferred4_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
