    ...
    outputs: [
      {
        ...
        internalType: 'structStructs.GuardianSet',
        name: '',
        type: 'tuple',
      },
    ],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'uint32', name: 'guardianSetIndex', type: 'uint32' },
          {
            ...
            internalType: 'structStructs.Signature[]',
            name: 'signatures',
            type: 'tuple[]',
          },
          { internalType: 'bytes32', name: 'hash', type: 'bytes32' },
        ],
        internalType: 'structStructs.VM',
        name: 'vm',
        type: 'tuple',
      },
    ...
    outputs: [
      {
        ...
        internalType: 'structGovernanceStructs.ContractUpgrade',
        name: 'cu',
        type: 'tuple',
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: 'structGovernanceStructs.GuardianSetUpgrade',
        name: 'gsu',
        type: 'tuple',
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: 'structGovernanceStructs.SetMessageFee',
        name: 'smf',
        type: 'tuple',
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: 'structGovernanceStructs.TransferFees',
        name: 'tf',
        type: 'tuple',
      },
    ],
