 ...
 * @returns {string}
 */
module.exports.calculate_out_given_in = function(reserves, asset_in, asset_out, amount_in, amplification, fee, pegs) {
    let deferred6_0;
    let deferred6_1;
    try {
 ...
 * @returns {string}
 */
module.exports.calculate_in_given_out = function(reserves, asset_in, asset_out, amount_out, amplification, fee, pegs) {
    let deferred6_0;
    let deferred6_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {string}
 */
module.exports.calculate_shares = function(reserves, assets, amplification, share_issuance, fee, pegs) {
    let deferred7_0;
    let deferred7_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {string}
 */
module.exports.calculate_spot_price_with_fee = function(pool_id, reserves, amplification, asset_in, asset_out, share_issuance, fee, pegs) {
    let deferred9_0;
    let deferred9_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {string}
 */
module.exports.calculate_shares_for_amount = function(reserves, asset_in, amount, amplification, share_issuance, fee, pegs) {
    let deferred7_0;
    let deferred7_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {string}
 */
module.exports.calculate_add_one_asset = function(reserves, shares, asset_in, amplification, share_issuance, fee, pegs) {
    let deferred7_0;
    let deferred7_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {string}
 */
module.exports.calculate_liquidity_out_one_asset = function(reserves, shares, asset_out, amplification, share_issuance, withdraw_fee, pegs) {
    let deferred7_0;
    let deferred7_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @param {string} current_pegs_updated_at
 ...
 * @returns {string}
 */
module.exports.recalculate_peg = function(current_pegs, current_pegs_updated_at, target_pegs, current_block, max_peg_update, pool_fee) {
    let deferred7_0;
    let deferred7_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(current_pegs_updated_at, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(target_pegs, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(current_block, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passStringToWasm0(max_peg_update, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len4 = WASM_VECTOR_LEN;
        const ptr5 = passStringToWasm0(pool_fee, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len5 = WASM_VECTOR_LEN;
        wasm.recalculate_peg(retptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, ptr5, len5);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred7_0 = r0;
        deferred7_1 = r1;
